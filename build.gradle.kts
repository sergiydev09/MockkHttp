...
intellijPlatform {
    ...
    pluginConfiguration {
        ...
        changeNotes = """
            ...
            <ul>
                <li><strong>Step 1:</strong> Add <code>id("io.github.sergiydev09.mockkhttp") version "1.5.1"</code> to plugins block</li>
            ...
            <ul>
                ...
                <li><strong>Gradle plugin:</strong> <code>id("io.github.sergiydev09.mockkhttp") version "1.5.1"</code></li>
            </ul>
        """.trimIndent()
    }
}
