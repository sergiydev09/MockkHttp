...
[![Version](https://img.shields.io/badge/version-1.4.29-green.svg)]()
...
cd MockkHttp
./gradlew buildPlugin
# Install build/distributions/MockkHttp-1.4.29.zip via Settings > Plugins > Install from Disk
```
...
plugins {
    ...
    kotlin("android")
    id("io.github.sergiydev09.mockkhttp") version "1.4.29"  // Add this
}
...
dependencies {
    ...
    debugImplementation("com.github.sergiydev09.MockkHttp:mockk-http-interceptor:1.4.29")
}

// ✅ Just apply the plugin - it handles everything
plugins {
    id("io.github.sergiydev09.mockkhttp") version "1.4.29"
}
```
